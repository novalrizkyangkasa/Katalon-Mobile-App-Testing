...
Mobile.verifyElementText(findTestObject('Object Repository/My Task Android App/Re installing after create task/androidx.recyclerview.widget.RecyclerView'), 
    '')
